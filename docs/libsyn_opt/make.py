...
from makefloat_opt.print_assign_diff import print_assign_diff_all
...
if __name__ == '__main__':
    ...
    print_assign_diff_all(OptimalRUNS, save_float_folder="float")
    ...
    plot_gantt(runs_foler="../../workplace/RUNS", run_name="VS-04-06-1-1", save_float_folder="./float",
               anno_reaction_index=False, multi_capacity=True)
