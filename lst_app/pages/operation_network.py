...
from libsyn_tools.chem_schema import Chemical, OperationNetwork, Operation
from libsyn_tools.utils import json_load, FilePath, CytoEdgeData, CytoNodeData
...
TARGET_JSON = "operation_network.json"
...
def load_operation_network(network_folder: FilePath) -> dict:
